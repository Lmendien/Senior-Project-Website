...
define('CRAFT_BASE_PATH', realpath(str_replace("plugins/tournamentdata", '', exec('pwd'))).'/');
...
// Craft craps itself if there is no server or request path
...
// Load plugin
require_once CRAFT_PLUGINS_PATH.'tournamentdata/TournamentDataPlugin.php';
require_once CRAFT_PLUGINS_PATH.'tournamentdata/vendor/autoload.php';